...
vector_index_id = client.spaces.promote("51651661-c6bb-4f72-8484-eb4488d14dda", source_project_id, space_id)
...
custom_sw_spec_name = "rag-milvus-software-spec"
try:
...
ai_service_metadata = {
    client.repository.AIServiceMetaNames.NAME: "rag service - milvus",
...
deployment_custom = {}
deployment_metadata = {
    client.deployments.ConfigurationMetaNames.NAME: "rag service - milvus",
...
print(deployment_id)
messages = []
remote_question = "Who won Best Actor?"
